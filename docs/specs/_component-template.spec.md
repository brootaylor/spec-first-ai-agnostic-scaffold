...
The status of the spec determines whether an agent may proceed with implementation.
...
Describe exactly what the component renders and does on first mount with only the required props supplied.
